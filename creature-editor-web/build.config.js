...
module.exports = {
	...
	vendor_files : {
		 ...
		 * 'vendor/html5shiv/dist/html5shiv-printshiv.js', 'vendor/placeholders/angular-placeholders-0.0.1-SNAPSHOT.min.js',
		 * 'vendor/angular-ui-router/release/angular-ui-router.min.js', 'vendor/angular-ui-utils/modules/route/route.js',
		 * 'vendor/angular-route/angular-route.min.js', 'vendor/ng-grid/ng-grid-2.0.7.min.js' ],
		 */
		js : [ 'vendor/jquery/jquery.js', 'vendor/jquery-ui/ui/jquery-ui.js', 'vendor/angular/angular.js', 'vendor/angular-bootstrap/ui-bootstrap-tpls.js',
				...
				'vendor/select2/select2.js', 'vendor/angular-ui-select2/src/select2.js' ],
