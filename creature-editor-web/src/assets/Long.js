...
/**
 * @license Long.js (c) 2013 Daniel Wirtz <dcode@dcode.io> Released under the Apache License, Version 2.0 see: https://github.com/dcodeIO/Long.js for details
 */
(function(global) {
	"use strict";

	/**
	 * Constructs a 64 bit two's-complement integer, given its low and high 32 bit values as *signed* integers. See the from* functions below for more convenient ways of
	 * constructing Longs.
	 * 
	 * @exports Long
	 * @class A Long class for representing a 64 bit two's-complement integer value.
	 * @param {number}
	 *           low The low (signed) 32 bits of the long
	 * @param {number}
	 *           high The high (signed) 32 bits of the long
	 * @param {boolean=}
	 *           unsigned Whether unsigned or not, defaults to `false` for signed
	 * @constructor
	 */
	 ...
	 * 
	 * @param {number}
	 *           value The 32 bit integer in question
	 * @param {boolean=}
	 *           unsigned Whether unsigned or not, defaults to `false` for signed
	 ...
	 * 
	 * @param {string}
	 *           str The textual representation of the Long
	 * @param {(boolean|number)=}
	 *           unsigned Whether unsigned or not, defaults to `false` for signed
	 * @param {number=}
	 *           radix The radix in which the text is written (2-36), defaults to 10
	 * @returns {!Long} The corresponding Long value
	 * @expose
	 */
	 ...
	 * 
	 * @param {!Long|number|string|!{low:
	 *           number, high: number, unsigned: boolean}} val Value
	 * @returns {!Long}
	 * @expose
	 */
	 ...
	 * 
	 * @param {number=}
	 *           radix Radix (2-36), defaults to 10
	 * @returns {string}
	 * @override
	 * @throws {RangeError}
	...
	Long.prototype.toString = function(radix) {
		...
		var result = '';
		while (true) {
			var remDiv = rem.div(radixToPower), intval = rem.subtract(remDiv.multiply(radixToPower)).toInt() >>> 0, digits = intval.toString(radix);
			rem = remDiv;
			if (rem.isZero()) {
