    ...
    a.extend(a.jqx.utilities, {
        ...
        resize: function (d, m, l, k) {
            ...
            var h = function (p, u) {
                ...
                for (var r = 0; r < f.resizeHandlers.length; r++) {
                    var x = f.resizeHandlers[r];
                    var t = x.widget;
                    var q = x.data;
                    if (!q) {
                        continue
                    ...
                    var n = q.jqxWidget.width;
                    var w = q.jqxWidget.height;
                    if (q.jqxWidget.base) {
                        if (n == undefined) {
                            n = q.jqxWidget.base.width
                        }
                        if (w == undefined) {
                            w = q.jqxWidget.base.height
                        }
                    }
                    var s = false;
                    ...
                    if (w != null && w.toString().indexOf("%") != -1) {
                        s = true
                    }
                    if (a.jqx.isHidden(t)) {
                        if (c(t) === -1) {
                            if (s || p === true) {
                                if (x.data.nestedWidget !== true) {
                                    f.hiddenWidgets.push(x)
                                }
                            }
                        }
                    } else {
                        if (p === undefined || p !== true) {
                            if (s) {
                                x.callback(u);
                                if (f.hiddenWidgets.indexOf(x) >= 0) {
                                    f.hiddenWidgets.splice(f.hiddenWidgets.indexOf(x), 1)
                                }
                            }
                        }
                    }
                ...
                if (f.hiddenWidgets.length > 0) {
                    ...
                    f.__resizeInterval = setInterval(function () {
                        var z = false;
                        var B = new Array();
                        for (var A = 0; A < f.hiddenWidgets.length; A++) {
                            var y = f.hiddenWidgets[A];
                            if (a.jqx.isHidden(y.widget)) {
                                z = true;
                                B.push(y)
                            } else {
                                if (y.callback) {
