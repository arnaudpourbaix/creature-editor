(function() {
	...
	var module = angular.module('cgNotify', []);

	// angular.module('cgNotify').value('cgNotifyTemplateName', 'angular-notify.html');

	module.factory('notify', [ '$timeout', '$http', '$compile', '$templateCache', '$rootScope', function($timeout, $http, $compile, $templateCache, $rootScope) {
		var startTop = 10;
		...
		var notify = function(args) {
			...
			// args.template = args.template ? args.template : '<div class="cg-notify-message">{{message}}</div>';
