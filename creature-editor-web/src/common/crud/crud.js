(function() {
	...
	// angular.module('crud', [ 'crud.directives' ]);

	var crud = angular.module('crud.routeProvider', [ 'ngRoute' ]);

	function crudRouteProvider($routeProvider) { /* jshint -W040 */
	...
	crud.provider('crudRoute', crudRouteProvider);
