...
describe('crud directive', function() {
	"use strict";
	...
	describe('scope methods', function() {
		...
		describe('save', function() {
			...
			it('should call resource.$save with attribute callbacks if specified', function() {
				// We must recompile/link the directive to get it to pick up the new callbacks
				inject(function($compile) {
					...
					element = $compile('<form name="form" crud-edit="resource" on-save="onSaveAttr" on-error="onErrorAttr"><input name="someField" ng-model="resource.someVal"></form>')
							($rootScope);
					scope = element.scope();
				});
