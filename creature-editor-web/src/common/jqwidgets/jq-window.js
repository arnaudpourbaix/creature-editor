angular.module('apx-jqwidgets.window', [])
	
.service('$jqWindow', function($jqCommon, $injector, $rootScope, $q, $http, $templateCache, $controller, $compile, $interpolate, $state) {
	var options = {
...
.directive('jqWindow', function($compile, $timeout, $jqCommon, $jqWindow) {
	return {
		restrict : 'AE',
