angular.module('apx-jqwidgets.dropdownlist', [])

.provider('$jqDropdownlist', function() {
	var options = {
...
.directive('jqDropDownList', function($compile, $timeout, $parse, $jqCommon, $jqDropdownlist) {
	return {
		restrict : 'AE',
		require : 'ngModel',
