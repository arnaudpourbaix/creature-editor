...
(function(_) {
	...
	module.controller('SpellListController', function SpellListController($scope, $stateParams, $location, $translateWrapper, spells, crudListMethods, $alertMessage, $interpolate) {
		...
		var setSpellGrid = function() {
			$translateWrapper(
					[ 'SPELL.FIELDS.RESOURCE', 'SPELL.FIELDS.NAME', 'SPELL.FIELDS.LEVEL', 'SPELL.FIELDS.IDENTIFIER', 'SPELL.FIELDS.TYPE', 'SPELL.FIELDS.SCHOOL',
							'SPELL.FIELDS.SECONDARY_TYPE', 'SPELL.COLUMNS.ACTION', 'SPELL.COLUMNS.DELETE' ]).then(function(labels) {
				$scope.spellGrid = {
					data : 'spells',
					columns : [ {
	...
	module.controller('SpellImportController', function SpellImportController($scope, $windowInstance, SpellImportService, mod) {
		$scope.mod = mod;
	...
	module.controller('SpellEditController', function SpellEditController($scope, $q, $translateWrapper, $state, $stateParams, SpellService) {
