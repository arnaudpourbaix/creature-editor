...
.controller('ModListController', function($scope, $translateWrapper, crudListMethods, $alertMessage, $interpolate, mods) {
...
.controller('ModEditController', function($scope, $state, $stateParams, ModService) {
