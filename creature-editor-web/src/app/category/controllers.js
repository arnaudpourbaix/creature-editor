(function() {
	...
	module.controller('CategoryListController', [ '$scope', '$translate', '$q', 'categories',
			function CategoryListController($scope, $translate, $q, categories) {
						...
						events : {
							...
							contextMenu : {
								items : [ {
									...
									label : 'Remove item',
									action : function($scope, category) {
										console.log('remove item', category);
									}
								} ]
							}
						}
