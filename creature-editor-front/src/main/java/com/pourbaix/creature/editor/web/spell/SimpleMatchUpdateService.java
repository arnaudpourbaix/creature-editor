 ...
 * 
 * This service code is WRONG and totally un-workable for a 'proper' application. Please DON'T use it as a real service.
 * 
 * @author Roger
 * 
...
public class SimpleMatchUpdateService {
	...
	private static final Logger logger = LoggerFactory.getLogger(SimpleMatchUpdateService.class);
