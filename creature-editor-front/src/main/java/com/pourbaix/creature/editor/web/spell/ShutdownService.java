...
/**
 * This is the shutdown service. It creates a shutdown hook thread (that runs on JVM shutdown - obviously), which loops through all the Hook instances getting
 * them to shutdown cleanly.]
 * 
 * @author Roger
 * 
 */
