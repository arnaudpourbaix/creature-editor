...
public final class ProSingleType extends AbstractStruct {
	private static final LongIntegerHashMap<String> s_facetarget = new LongIntegerHashMap<String>();
	private static final String[] s_flags = { "No flags set", "Colored BAM", "Creates smoke", "Colored smoke", "Not light source", "Modify for height",
