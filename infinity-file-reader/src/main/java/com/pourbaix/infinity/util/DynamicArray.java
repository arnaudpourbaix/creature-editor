...
public class DynamicArray {
	 ...
	 * 
	 * @param b
	 *            The array that will back this object.
	 * @param type
	 *            The logical data type of the array.
	 * @return An array object of the specified logical element type.
	 */
	 ...
	 *            The array that will back this object.
	 * @param ofs
	 *            The start ofs of the array that backs this object.
	 * @param type
	 *            The logical data type of the array.
	 * @return An array object of the specified logical element type.
	 */
	...
	/**
	 * Indicates whether this object is equal to another. The objects are equal if both point to the same array and are set to the same base offset.
	 * 
	 * @return true if both objects refer to the same array, starting at the same base offset. false otherwise.
	 */
	@Override
	...
	/**
	 * Sets a new base offset for the underlying array. All read/write operations take this offset into account automatically.
	 * 
	 * @param baseOffset
	 *            The new base offset.
	 * @return This object
	 ...
	 * 
	 * @param index
	 *            Adds an offset of <code>index</code> elements to the current base offset. Can be negative.
	 * @return This object
	 */
	 ...
	 * 
	 * @param baseOfs
	 *            The start offset of the underlying array (offset in bytes).
	 * @return A dynamic array of the current buffer with a byte element size.
	 */
	 ...
	 * 
	 * @param index
	 *            The logical index of the the value.
	 ...
	 * 
	 * @param index
	 *            The logical index within the array to write the value to.
	 * @param v
	 *            The value to write
	 * @return This object
	 */
	 ...
	 * 
	 * @param index
	 *            The logical starting index of the the subarray.
	 * @param size
	 *            The size of the the subarray in bytes.
	 ...
	 * 
	 * @param index
	 *            The logical starting index to write the subarray to.
	 * @param b
	 *            The subarray to write
	 * @return This object
	 */
	 ...
	 *            The subarray to write
	 * @param ofs
	 *            The start offset of the subarray
	 * @param len
